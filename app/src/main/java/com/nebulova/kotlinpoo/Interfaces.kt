...
//TRADUCCIÓN
La regla de los single-parents a menudo se vuelve demasiado restrictiva,
ya que a menudo encontrará puntos en común entre las clases en
diferentes ramas de una jerarquía de clases.
Estos puntos en común se pueden expresar en interfaces.

Una interfaz es esencialmente un contrato que un
la clase puede optar por firmar; si lo hace, la clase
está obligado a proporcionar implementaciones de las propiedades
y funciones de la interfaz.
Sin embargo, una interfaz puede (pero normalmente no lo hace)
proporcionar una implementación predeterminada de algunos o todos
de sus propiedades y funciones. Si una propiedad o
la función tiene una implementación predeterminada,
la clase puede optar por anularlo,
